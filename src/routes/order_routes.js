...
import { notificationUpdate_Read, notification_Get, notification_Update, order_Create, order_Delete, order_Get, order_Update, order_UpdatebyTailor } from "../controllers/order_controller.js";

routes.post('/order',protect,upload.single("pic"), order_Create)
routes.put('/order/:_id',protect, order_Update)
routes.put('/order_assigntailor/:_id',protect, order_UpdatebyTailor)
